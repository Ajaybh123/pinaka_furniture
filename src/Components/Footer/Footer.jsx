    ...
    <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
        <p className="text-sm sm:text-base text-gray-400 text-center">
          © 2025 Pinaka Art & Exports — Designed & Developed by <span className="text-white font-medium">Web4businesssolutions</span>
        </p>
        <div className="flex flex-wrap justify-center gap-4 text-gray-400 text-sm sm:text-base">
          <p className="flex items-center gap-2"><PhoneCall size={16} />+91-8070207280</p>
